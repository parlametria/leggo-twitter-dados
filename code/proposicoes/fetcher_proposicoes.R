...
#' @title Baixa todas as proposições
#' @description Retorna as proposições monitoradas pelo Leggo.
#' @return Dataframe com informações das proposições.
fetch_proposicoes <-
  function() {
    library(tidyverse)
    
    print(paste0("Baixando proposições..."))
    
    url <-
      paste0("https://api.leggo.org.br/proposicoes/?format=json")
